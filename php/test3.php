                ...
                <fieldset>
                    ...
                    <table class="table table-hover ">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="year" disabled="true" value="<?php echo $year; ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="sem" disabled="true" value="<?php echo $sem; ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="programme" disabled="true" value="<?php echo $programme  ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="credithours" disabled="true" value="<?php echo $credithours; ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="category" disabled="true" value="<?php echo $category; ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="prerequisite" disabled="true" value="<?php echo $prerequisite; ?>">
                                </div></br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control px-3 display-7" type="text" name="info" disabled="true" value="<?php echo $info; ?>">
                                </div></br>
                            </td>
                        </tr>
